import type { DeploymentConfig, DaemonSetConfig, KubernetesResource, Namespace, ConfigMap, Secret, ServiceAccount, ProjectSettings, JobConfig, CronJobConfig, Container, EnvVar, DockerHubSecret, KubernetesRole, KubernetesClusterRole, PolicyRule, CustomResourceDefinition, CustomResource } from '../types';
...
data:
  ...
  // Add header comment
  if (deployments.length > 0 || daemonSets.length > 0 || customNamespaces.length > 0 || configMaps.length > 0 || secrets.length > 0 || dockerHubSecrets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || serviceAccounts.length > 0 || roles.length > 0 || clusterRoles.length > 0 || roleBindings.length > 0 || crds.length > 0 || customResources.length > 0) {
    ...
    if (customResources.length > 0) {
      allResources.push(`# Custom Resources: ${customResources.length}`);
    }
    allResources.push('');
  }
  ...
  if (customNamespaces.length > 0) {
    ...
    if (configMaps.length > 0 || secrets.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (configMaps.length > 0) {
    ...
    if (secrets.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (secrets.length > 0) {
    ...
    if (dockerHubSecrets.length > 0 || serviceAccounts.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (dockerHubSecrets.length > 0) {
    ...
    if (serviceAccounts.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (serviceAccounts.length > 0) {
    ...
    if (roles.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (roles.length > 0) {
    ...
    if (clusterRoles.length > 0 || deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (clusterRoles.length > 0) {
    ...
    if (deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (roleBindings.length > 0) {
    ...
    if (deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
  ...
  if (crds.length > 0) {
    allResources.push('# === CUSTOM RESOURCE DEFINITIONS ===');
    crds.forEach((crd, index) => {
      if (index > 0) {
        allResources.push('---');
      }
      if (crd.rawYaml) {
        allResources.push(crd.rawYaml);
      }
    });
    if (deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || customResources.length > 0) {
      allResources.push('---');
  ...
  // Generate Custom Resource resources
  if (customResources.length > 0) {
    allResources.push('# === CUSTOM RESOURCES ===');
    customResources.forEach((cr, index) => {
      if (index > 0) {
        allResources.push('---');
      }

      // Add global labels if project settings exist
      const metadata: any = {
        name: cr.name,
        ...(cr.namespace && { namespace: cr.namespace })
      };

      if (projectSettings && Object.keys(projectSettings.globalLabels).length > 0) {
        metadata.labels = {
          ...projectSettings.globalLabels,
          project: projectSettings.name
        };
      ...
      const crResource: KubernetesResource = {
      ...
      allResources.push(objectToYaml(crResource));
    });
    if (deployments.length > 0 || daemonSets.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
  ...
  if (daemonSets.length > 0) {
    ...
    if (deployments.length > 0 || jobs.length > 0 || cronjobs.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
  }
...
# 4. Your YAML will appear here automatically`;
  ...
  if (jobs.length > 0 || cronjobs.length > 0) {
    if (customNamespaces.length > 0 || configMaps.length > 0 || secrets.length > 0 || deployments.length > 0 || daemonSets.length > 0 || roleBindings.length > 0 || customResources.length > 0) {
      allResources.push('---');
      allResources.push('');
    }
...
export function generateCrdYaml(crds: CustomResourceDefinition[]): string {
...
export function generateCustomResourceYaml(customResources: CustomResource[], projectSettings?: ProjectSettings): string {
  if (!customResources || customResources.length === 0) return '';
